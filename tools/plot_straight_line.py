...
# ── Steering / PI panel ─────────────────────────────────────────────────────
plot_if(ax2, dist, error,                            label=f"error      (σ={σ(error):.3f}, μ={mean(error):.3f})", color="tab:red")
plot_if(ax2, dist, p_term,                           label="P term (m/s)", color="tab:purple")
plot_if(ax2, dist, i_term,                           label="I term (m/s)", color="tab:green")
